...
export default function Home() {
  ...
  const {href} = useHrefStore();
    ...
    let stringToDisplay = `On the next page, you can chat with a chatbot about the party programme. 
    ...
    if (href === '/chat') {
        stringToDisplay = `On the next page, you will see the party programme as a PDF. It may take up to 5 seconds to load the PDF. 
